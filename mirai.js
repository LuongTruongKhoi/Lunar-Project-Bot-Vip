...
console.log(chalk.bold.hex("#f70505").bold("『 LUNAR 』→ vui lòng chờ 5s - 20s kích hoạt bot (tùy vào mạng nhà bạn)"));
...
(async() => {
    try {
        ...
        onBot(botData);
    } catch (error) { logger(global.getText('mirai', 'successConnectDatabase', JSON.stringify(error)), '[ TrKhoi ctee ] '); }
  })()
